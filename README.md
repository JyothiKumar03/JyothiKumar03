...
<img 
  src="https://capsule-render.vercel.app/api?type=waving&height=230&text=Jyothi%20Kumar%20Dummala&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=AI%20Engineer%20×%20Full%20Stack%20Builder%20&descAlignY=60&descSize=17&descColor=F3F4F6&color=0:000000,25:0F0F0F,55:3B0000,80:7F1D1D,100:DC2626"
/>
...
obsession  : Production AI systems. Not demos. Not notebooks. Real systems, real users.
...
- **Agentic Workflows** - agentic-based multi-step agents with logging, eval loops, and improving feedback. The kind that actually run in production.
- **AI-native Customer Platforms** — KB → Web fallback → Ticket escalation pipelines with confidence scoring and KB feedback loops.
- **Long running agents** - agents which can plan, perform, auto clear their own context without hallucinations
...
| OpenAI / Anthropic / Gemini | Node.js / Express | TypeScript | Redis |
| RAG · Hybrid Search · Re-ranking | REST / WebSockets | Tailwind CSS | Pinecone / Milvus |
| Voice AI (Bolna / Twilio) | Docker | — | AWS (ECS, S3, DynamoDB) |
...
def my_engineering_philosophy():
    principles = [
        ...
        "Talking to the founders, teams, understanding the domains"
...
`~2 years` shipping production AI · `IC + Lead` experience · `Full-stack` across Python, Node, React ·  `Agents, RAG, Evals, Voice AI` in production
